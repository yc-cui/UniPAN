...
class MDCUN(BaseModel):
    def __init__(self,
        ...
        self.model = pan_unfolding(bands=bands)
        self.loss = l1_loss
    ...
    def forward(self, transformed_ms_down, transformed_pan_down, 
        ...
        pred = self.model(transformed_ms_down, None, transformed_pan_down) + ori_ms_down_up
        return dict_of(pred)
